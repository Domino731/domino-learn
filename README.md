...
|editableHTML| boolean| this value gives ability to user to change html code. If you don't want user to be able to change html code, set this value to false |
